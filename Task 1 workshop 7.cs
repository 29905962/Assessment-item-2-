...
private void DepthFirstTraversal(Node<T> node, List<T> result)
{
    if (node == null)
    {
        return;
    ...
    DepthFirstTraversal(node.Left, result);

    // Traverse right subtree
    DepthFirstTraversal(node.Right, result);
}
